...
Date: 2024-07-29 20:57:41
LastEditors: chenhao1999 1027783090@qq.com
LastEditTime: 2024-07-29 21:16:34
FilePath: \llm_project\数据处理\process_union.py
Description: 给两个文件取并集
'''
import pandas as pd
...
output_path = r'数据处理\raw_union.xlsx'
